...
class MY_TwitterWidget extends WP_Widget {
  ...
  /** @see WP_Widget::widget */
    function widget($args, $instance) {		
        extract( $args );
        $title = apply_filters('widget_txt', $instance['title']);
...
<div id="twitter-<?php echo $suf; ?>" class="twitter"></div>
    ...
    function form($instance) {				
      ...
      <p><label for="<?php echo $this->get_field_id('twitter_name'); ?>"><?php _e('Twitter Name:', 'astrology'); ?> <input class="widefat" id="<?php echo $this->get_field_id('twitter_name'); ?>" name="<?php echo $this->get_field_name('twitter_name'); ?>" type="text" value="<?php echo $twitter_name; ?>" /></label></p>
      <p><label for="<?php echo $this->get_field_id('twitts_amount'); ?>"><?php _e('Twitts number:', 'astrology'); ?> <input class="widefat" id="<?php echo $this->get_field_id('twitts_amount'); ?>" name="<?php echo $this->get_field_name('twitts_amount'); ?>" type="text" value="<?php echo $amount; ?>" /></label></p>	
