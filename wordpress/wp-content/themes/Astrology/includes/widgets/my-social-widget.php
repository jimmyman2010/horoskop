	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<ul class="social-networks">
					...
					<?php foreach(array("Facebook", "Twitter", "Flickr", "Feed", "Linkedin", "Delicious", "Youtube", "Google", "Pinterest", "Blogger", "Tumblr", "Vimeo", "Instagram") as $network) : ?>
...
?>
        ...
        <fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
	    	...
	    	<p><label for="<?php echo $this->get_field_id('pinterest'); ?>"><?php _e('Pinterest URL:'); ?></label>
	        ...
	        <p><label for="<?php echo $this->get_field_id('pinterest_label'); ?>"><?php _e('Pinterest label:'); ?></label>
		...
		<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
	    	...
	    	<p><label for="<?php echo $this->get_field_id('blogger'); ?>"><?php _e('Blogger URL:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('blogger'); ?>" name="<?php echo $this->get_field_name('blogger'); ?>" type="text" value="<?php echo esc_attr($blogger); ?>" /></p>
	        <p><label for="<?php echo $this->get_field_id('blogger_label'); ?>"><?php _e('Blogger label:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('blogger_label'); ?>" name="<?php echo $this->get_field_name('blogger_label'); ?>" type="text" value="<?php echo esc_attr($blogger_label); ?>" /></p>
        </fieldset>	  
		...
		<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
	        ...
	        <p><label for="<?php echo $this->get_field_id('tumblr_label'); ?>"><?php _e('Tumblr label:'); ?></label>
    	...
    	<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
	    	...
	    	<p><label for="<?php echo $this->get_field_id('instagram'); ?>"><?php _e('instagram URL:'); ?></label>
	        ...
	        <p><label for="<?php echo $this->get_field_id('instagram_label'); ?>"><?php _e('Instagram label:'); ?></label>
