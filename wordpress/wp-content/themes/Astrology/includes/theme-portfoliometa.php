...
$meta_box_portfolio = array(
	...
	'title' =>  __('Portfolio Options', 'astrology'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
			'name' =>  __('Format', 'astrology'),
			'desc' => __('Choose post format that most fit your needs. ', 'astrology'),
    	...
    	array(
    	   'name' => __('Date', 'astrology'),
    	   'desc' => __('Input project end date. ', 'astrology'),
    	   'id' => $prefix . 'portfolio_date',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Client', 'astrology'),
    	   'desc' => __('Input project owner name. ', 'astrology'),
    	   'id' => $prefix . 'portfolio_client',
    	   'type' => 'text',
    	   'std' => ''
    	),
			array(
    	   'name' => __('Info', 'astrology'),
    	   'desc' => __('Additional info for this portfolio item.', 'astrology'),
    	   'id' => $prefix . 'portfolio_info',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('URL', 'astrology'),
    	   'desc' => __('Input the project URL (external link)', 'astrology'),
...
$meta_box_portfolio_video = array(
	...
	'title' => __('Video Settings', 'astrology'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Embedded Code', 'astrology'),
			'desc' => __('Use this field to embed video from various websites (YouTube, Vimeo etc).', 'astrology'),
...
$meta_box_portfolio_audio = array(
	...
	'title' =>  __('Audio Settings', 'astrology'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( 
		    "name" => __('MP3 File URL','astrology'),
				"desc" => __('The URL to the .mp3 audio file','astrology'),
				"id" => $prefix."audio_mp3",
				"type" => "text",
				'std' => ''
		)
...
function tz_show_box_portfolio() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please choose desired Portfolio Format and fill additional fields. ', 'astrology').'</p>';
