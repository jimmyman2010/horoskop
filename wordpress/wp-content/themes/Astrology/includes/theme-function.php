...
function astrology_random($length){
					...
					<div class="grid_gallery clearfix">
						...
						?>
								...
								<?php foreach ($attachments as $attachment) : ?>
										...
										$image = aq_resize($url, 450, 300, true);
										?>
...
if ( !function_exists( 'tz_gallery' ) ) {
    function tz_gallery($postid, $imagesize) { ?>
        <?php $random = astrology_random(10); ?>
				<script type="text/javascript">
					...
					<div class="g_pagination">
						...
						<div class="g_controls">
							<a href="#"><span id="prev-gal"><?php _e('&larr;', 'astrology'); ?></span></a> 
							<a href="#"><span id="next-gal"><?php _e('&rarr;', 'astrology'); ?></span></a>
						</div><!--END Prev&Next -->
