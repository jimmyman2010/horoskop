...
$meta_box_quote = array(
	...
	'title' =>  __('Quote Settings', 'astrology'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The Quote','astrology'),
				"desc" => __('Put your quote in this field.','astrology'),
				"id" => $prefix."quote",
				"type" => "textarea"
			),
	),
...
$meta_box_link = array(
	'id' => 'tz-meta-box-link',
	'title' =>  __('Link Settings', 'astrology'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The URL','astrology'),
				"desc" => __('Insert the URL you wish to link to.','astrology'),
				"id" => $prefix."link_url",
				"type" => "text"
			),
	),
...
$meta_box_image = array(
	...
	'title' =>  __('Image Settings', 'astrology'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Enable Lightbox','astrology'),
				"desc" => __('Check this to enable the lightbox.','astrology'),
...
$meta_box_audio = array(
	...
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('MP3 File URL','astrology'),
...
$meta_box_video = array(
	...
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Embeded Code','astrology'),
				"desc" => __('You can include embeded code here.','astrology'),
