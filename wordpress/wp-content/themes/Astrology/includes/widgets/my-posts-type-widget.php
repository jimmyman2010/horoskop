  ...
  $cat_posts = new WP_Query($args);
    ...
    ?>
        ...
        <?php if ( $instance['show_title'] ) : ?>
			  <?php echo $instance["before_post_title"]; ?>
        ...
        <?php echo $instance["after_post_title"]; ?>
          ...
          <?php if ( $instance['excerpt'] ) : ?>
            ...
            <?php } ?>
            <?php endif; ?>
            <?php if ( $instance['show_title_date'] ) { ?> 
                <div class="date"> 
                  <?php the_time('d F, Y'); ?> 
                </div>
            <?php } ?>
        ...
        <div class="post-meta-wrapper">
            ...
            <?php if ( $instance['date'] ) : ?>
              <span class="post_meta">
                ...
                <time datetime="<?php the_time('Y-m-d\TH:i'); ?>"><?php the_time('j'); echo " of "; the_time('F Y'); ?></time>
              </span>
            <?php endif; ?>
            ...
            <?php if ( $instance['more_link'] ) : ?>
              <a href="<?php the_permalink() ?>" class="<?php if($instance['more_link_class']!="") {echo $instance['more_link_class'];}else{ ?>link<?php } ?>"><?php if($instance['more_link_text']==""){ ?>more<?php }else{ ?><?php echo $instance['more_link_text']; ?><?php } ?></a>
            <?php endif; ?>
		</li>
	<?php } ?>
	<?php echo "</ul>\n"; ?>
...
<div style="width:230px; float:left; padding-left:20px;">
  ...
  <label for="<?php echo $this->get_field_id("more_link_text"); ?>">
    <?php _e( 'Link text' ); ?>:
    <input class="widefat" id="<?php echo $this->get_field_id("more_link_text"); ?>" name="<?php echo $this->get_field_name("more_link_text"); ?>" type="text" value="<?php echo esc_attr($instance["more_link_text"]); ?>" /> <span style="font-size:11px; color:#999;"><?php _e( '(default: "more")' ); ?></span>
  </label>
  </p>
  <p>
