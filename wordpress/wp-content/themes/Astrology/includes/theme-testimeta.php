...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'astrology'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Name', 'astrology'),
    	   'desc' => __('Input author\'s name. ', 'astrology'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input author\'s URL.', 'astrology'),
    	   'id' => $prefix . 'testi_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	   ...
    	   'desc' => __('Input author\'s additional info.', 'astrology'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'astrology').'</p>';
